  ...
  return (
    <section className="py-16 bg-black relative">
      ...
      <div className="relative max-w-4xl mx-auto">
        {/* Line */}
        <div className="absolute left-1/2 top-0 h-full w-[3px] bg-gradient-to-b from-yellow-400 via-purple-400 to-pink-500 transform -translate-x-1/2"></div>
        ...
        <div className="flex flex-col gap-12">
          {educationData.map((item, index) => (
            ...
            >
              {/* Dot */}
              <div className="absolute top-5 left-1/2 transform -translate-x-1/2 w-5 h-5 rounded-full bg-yellow-400 border-4 border-black shadow-lg"></div>

              {/* Card */}
              <div className="backdrop-blur-md bg-neutral-900/70 border border-neutral-700 rounded-2xl p-6 shadow-xl hover:border-yellow-400 hover:shadow-yellow-500/20 transition-all">
                ...
                <p className="text-sm md:text-base text-neutral-300">{item.desc}</p>
              </div>
            </motion.div>
          ))}
        </div>
